...
export const openpredict = $root.openpredict = (() => {
	...
	openpredict.Instruction = (function () {
		...
		Object.defineProperty(Instruction.prototype, "Contents", {
			get: $util.oneOfGetter($oneOfFields = ["initMarket", "initMarketAccount", "buyShares", "resolveMarket", "redeemShares", "createAccount"]),
	...
	openpredict.MarketData = (function () {
		 ...
		 * @instance
		 */
		Object.defineProperty(MarketData.prototype, "Contents", {
		...
		MarketData.encode = function encode(message, writer) {
			...
			if (message.v1 != null && Object.hasOwnProperty.call(message, "v1"))
				$root.openpredict.MarketData.V1.encode(message.v1, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
			return writer;
		};
		...
		MarketData.decode = function decode(reader, length) {
			if (!(reader instanceof $Reader))
				reader = $Reader.create(reader);
			let end = length === undefined ? reader.len : reader.pos + length, message = new $root.openpredict.MarketData();
			while (reader.pos < end) {
				let tag = reader.uint32();
				switch (tag >>> 3) {
					case 1: {
						message.v1 = $root.openpredict.MarketData.V1.decode(reader, reader.uint32());
						break;
					}
					default:
						reader.skipType(tag & 7);
		...
		MarketData.verify = function verify(message) {
			...
			if (message.v1 != null && message.hasOwnProperty("v1")) {
				properties.Contents = 1;
				{
					let error = $root.openpredict.MarketData.V1.verify(message.v1);
					if (error)
						return "v1." + error;
				}
			}
		...
		MarketData.fromObject = function fromObject(object) {
			if (object instanceof $root.openpredict.MarketData)
				return object;
			let message = new $root.openpredict.MarketData();
			if (object.v1 != null) {
				if (typeof object.v1 !== "object")
					throw TypeError(".openpredict.MarketData.v1: object expected");
				message.v1 = $root.openpredict.MarketData.V1.fromObject(object.v1);
			}
			return message;
		};
		...
		MarketData.toObject = function toObject(message, options) {
			...
			let object = {};
			if (message.v1 != null && message.hasOwnProperty("v1")) {
				object.v1 = $root.openpredict.MarketData.V1.toObject(message.v1, options);
				if (options.oneofs)
					object.Contents = "v1";
			}
			return object;
		...
		MarketData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
			...
			return typeUrlPrefix + "/openpredict.MarketData";
		};

		MarketData.V1 = (function () {
			 ...
			 * @instance
			 */
			V1.prototype.yes = $util.Long ? $util.Long.fromBits(0, 0, true) : 0;
			 ...
			 * @instance
			 */
			V1.prototype.no = $util.Long ? $util.Long.fromBits(0, 0, true) : 0;
			 ...
			 * @instance
			 */
			V1.prototype.subsidy = $util.Long ? $util.Long.fromBits(0, 0, true) : 0;
			 ...
			 * @instance
			 */
			V1.prototype.cid = $util.newBuffer([]);
			 ...
			 * @instance
			 */
			V1.prototype.ammAddress = $util.newBuffer([]);
			 ...
			 * @instance
			 */
			V1.prototype.userKey = $util.newBuffer([]);
			...
			V1.encode = function encode(message, writer) {
				...
				if (message.yes != null && Object.hasOwnProperty.call(message, "yes"))
					writer.uint32(/* id 1, wireType 0 =*/8).uint64(message.yes);
				if (message.no != null && Object.hasOwnProperty.call(message, "no"))
					writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.no);
				if (message.subsidy != null && Object.hasOwnProperty.call(message, "subsidy"))
					writer.uint32(/* id 3, wireType 0 =*/24).uint64(message.subsidy);
				if (message.cid != null && Object.hasOwnProperty.call(message, "cid"))
					writer.uint32(/* id 4, wireType 2 =*/34).bytes(message.cid);
				if (message.ammAddress != null && Object.hasOwnProperty.call(message, "ammAddress"))
					writer.uint32(/* id 5, wireType 2 =*/42).bytes(message.ammAddress);
				if (message.userKey != null && Object.hasOwnProperty.call(message, "userKey"))
					writer.uint32(/* id 6, wireType 2 =*/50).bytes(message.userKey);
				return writer;
			};
			 ...
			 * @throws {$protobuf.util.ProtocolError} If required fields are missing
			 */
			V1.decode = function decode(reader, length) {
				if (!(reader instanceof $Reader))
					reader = $Reader.create(reader);
				let end = length === undefined ? reader.len : reader.pos + length, message = new $root.openpredict.MarketData.V1();
				while (reader.pos < end) {
					let tag = reader.uint32();
					switch (tag >>> 3) {
						case 1: {
			...
			V1.verify = function verify(message) {
				...
				if (message.userKey != null && message.hasOwnProperty("userKey"))
					if (!(message.userKey && typeof message.userKey.length === "number" || $util.isString(message.userKey)))
						return "userKey: buffer expected";
				return null;
			};
			...
			V1.fromObject = function fromObject(object) {
				if (object instanceof $root.openpredict.MarketData.V1)
					return object;
				let message = new $root.openpredict.MarketData.V1();
				if (object.yes != null)
					if ($util.Long)
				...
				if (object.userKey != null)
					if (typeof object.userKey === "string")
						$util.base64.decode(object.userKey, message.userKey = $util.newBuffer($util.base64.length(object.userKey)), 0);
					else if (object.userKey.length >= 0)
			...
			V1.toObject = function toObject(message, options) {
				...
				if (options.defaults) {
					...
					if (options.bytes === String)
						...
						object.userKey = [];
						if (options.bytes !== Array)
							object.userKey = $util.newBuffer(object.userKey);
					}
				}
				if (message.yes != null && message.hasOwnProperty("yes"))
				...
				if (message.ammAddress != null && message.hasOwnProperty("ammAddress"))
					object.ammAddress = options.bytes === String ? $util.base64.encode(message.ammAddress, 0, message.ammAddress.length) : options.bytes === Array ? Array.prototype.slice.call(message.ammAddress) : message.ammAddress;
				if (message.userKey != null && message.hasOwnProperty("userKey"))
					object.userKey = options.bytes === String ? $util.base64.encode(message.userKey, 0, message.userKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.userKey) : message.userKey;
				return object;
			};
			...
			V1.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
				...
				return typeUrlPrefix + "/openpredict.MarketData.V1";
			};
	...
	openpredict.MarketUserData = (function () {
		 ...
		 */
		function MarketUserData(properties) {
			if (properties)
				for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
					if (properties[keys[i]] != null)
						this[keys[i]] = properties[keys[i]];
		 ...
		 * @instance
		 */
		MarketUserData.prototype.v1 = null;
		 ...
		 * @instance
		 */
		Object.defineProperty(MarketUserData.prototype, "Contents", {
			get: $util.oneOfGetter($oneOfFields = ["v1"]),
			set: $util.oneOfSetter($oneOfFields)
		});
		 ...
		 */
		MarketUserData.create = function create(properties) {
			return new MarketUserData(properties);
		};
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
		MarketUserData.encode = function encode(message, writer) {
			if (!writer)
				writer = $Writer.create();
			if (message.v1 != null && Object.hasOwnProperty.call(message, "v1"))
				$root.openpredict.MarketUserData.V1.encode(message.v1, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
			return writer;
		};
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
		MarketUserData.encodeDelimited = function encodeDelimited(message, writer) {
			return this.encode(message, writer).ldelim();
		};
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
		MarketUserData.decode = function decode(reader, length) {
			if (!(reader instanceof $Reader))
				reader = $Reader.create(reader);
			let end = length === undefined ? reader.len : reader.pos + length, message = new $root.openpredict.MarketUserData();
			while (reader.pos < end) {
				let tag = reader.uint32();
				switch (tag >>> 3) {
					case 1: {
						message.v1 = $root.openpredict.MarketUserData.V1.decode(reader, reader.uint32());
						break;
					}
					default:
						reader.skipType(tag & 7);
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
		MarketUserData.decodeDelimited = function decodeDelimited(reader) {
			if (!(reader instanceof $Reader))
				reader = new $Reader(reader);
			return this.decode(reader, reader.uint32());
		};
		 ...
		 * @returns {string|null} `null` if valid, otherwise the reason why it is not
		 */
		MarketUserData.verify = function verify(message) {
			if (typeof message !== "object" || message === null)
				return "object expected";
			let properties = {};
			if (message.v1 != null && message.hasOwnProperty("v1")) {
				properties.Contents = 1;
				{
					let error = $root.openpredict.MarketUserData.V1.verify(message.v1);
					if (error)
						return "v1." + error;
				}
			}
		 ...
		 * @returns {openpredict.MarketUserData} MarketUserData
		 */
		MarketUserData.fromObject = function fromObject(object) {
			if (object instanceof $root.openpredict.MarketUserData)
				return object;
			let message = new $root.openpredict.MarketUserData();
			if (object.v1 != null) {
				if (typeof object.v1 !== "object")
					throw TypeError(".openpredict.MarketUserData.v1: object expected");
				message.v1 = $root.openpredict.MarketUserData.V1.fromObject(object.v1);
			}
			return message;
		};
		 ...
		 * @returns {Object.<string,*>} Plain object
		 */
		MarketUserData.toObject = function toObject(message, options) {
			if (!options)
				options = {};
			let object = {};
			if (message.v1 != null && message.hasOwnProperty("v1")) {
				object.v1 = $root.openpredict.MarketUserData.V1.toObject(message.v1, options);
				if (options.oneofs)
					object.Contents = "v1";
			}
			return object;
		 ...
		 * @returns {Object.<string,*>} JSON object
		 */
		MarketUserData.prototype.toJSON = function toJSON() {
			return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
		};
		 ...
		 * @returns {string} The default type url
		 */
		MarketUserData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
			if (typeUrlPrefix === undefined) {
				typeUrlPrefix = "type.googleapis.com";
			}
			return typeUrlPrefix + "/openpredict.MarketUserData";
		};

		MarketUserData.V1 = (function () {
			 ...
			 * @instance
			 */
			V1.prototype.shares = $util.Long ? $util.Long.fromBits(0, 0, false) : 0;
			...
			V1.encode = function encode(message, writer) {
				if (!writer)
					writer = $Writer.create();
				if (message.userKey != null && Object.hasOwnProperty.call(message, "userKey"))
					writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.userKey);
				if (message.shares != null && Object.hasOwnProperty.call(message, "shares"))
					writer.uint32(/* id 2, wireType 0 =*/16).sint64(message.shares);
				return writer;
			};
			...
			V1.decode = function decode(reader, length) {
				if (!(reader instanceof $Reader))
					reader = $Reader.create(reader);
				let end = length === undefined ? reader.len : reader.pos + length, message = new $root.openpredict.MarketUserData.V1();
				while (reader.pos < end) {
					let tag = reader.uint32();
					switch (tag >>> 3) {
						case 1: {
			...
			V1.verify = function verify(message) {
				...
				if (message.shares != null && message.hasOwnProperty("shares"))
					if (!$util.isInteger(message.shares) && !(message.shares && $util.isInteger(message.shares.low) && $util.isInteger(message.shares.high)))
						return "shares: integer|Long expected";
				return null;
			};
			 ...
			 */
			V1.fromObject = function fromObject(object) {
				if (object instanceof $root.openpredict.MarketUserData.V1)
					return object;
				let message = new $root.openpredict.MarketUserData.V1();
				if (object.userKey != null)
					if (typeof object.userKey === "string")
						$util.base64.decode(object.userKey, message.userKey = $util.newBuffer($util.base64.length(object.userKey)), 0);
					else if (object.userKey.length >= 0)
				...
				if (object.shares != null)
					if ($util.Long)
						(message.shares = $util.Long.fromValue(object.shares)).unsigned = false;
					else if (typeof object.shares === "string")
						message.shares = parseInt(object.shares, 10);
					else if (typeof object.shares === "number")
						message.shares = object.shares;
					else if (typeof object.shares === "object")
						message.shares = new $util.LongBits(object.shares.low >>> 0, object.shares.high >>> 0).toNumber();
				return message;
			};
			...
			V1.toObject = function toObject(message, options) {
				...
				if (options.defaults) {
					...
					if ($util.Long) {
						...
						object.shares = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
					} else
						object.shares = options.longs === String ? "0" : 0;
				}
				if (message.userKey != null && message.hasOwnProperty("userKey"))
					object.userKey = options.bytes === String ? $util.base64.encode(message.userKey, 0, message.userKey.length) : options.bytes === Array ? Array.prototype.slice.call(message.userKey) : message.userKey;
				if (message.shares != null && message.hasOwnProperty("shares"))
					if (typeof message.shares === "number")
						object.shares = options.longs === String ? String(message.shares) : message.shares;
					else
						object.shares = options.longs === String ? $util.Long.prototype.toString.call(message.shares) : options.longs === Number ? new $util.LongBits(message.shares.low >>> 0, message.shares.high >>> 0).toNumber() : message.shares;
				return object;
			};
			...
			V1.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
				...
				return typeUrlPrefix + "/openpredict.MarketUserData.V1";
			};
	...
	openpredict.UserProfileData = (function () {
		 ...
		 * @instance
		 */
		UserProfileData.prototype.v1 = null;
		 ...
		 * @instance
		 */
		Object.defineProperty(UserProfileData.prototype, "Contents", {
			get: $util.oneOfGetter($oneOfFields = ["v1"]),
			set: $util.oneOfSetter($oneOfFields)
		});
		...
		UserProfileData.encode = function encode(message, writer) {
			if (!writer)
				writer = $Writer.create();
			if (message.v1 != null && Object.hasOwnProperty.call(message, "v1"))
				$root.openpredict.UserProfileData.V1.encode(message.v1, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
			return writer;
		};
		...
		UserProfileData.decode = function decode(reader, length) {
			if (!(reader instanceof $Reader))
				reader = $Reader.create(reader);
			let end = length === undefined ? reader.len : reader.pos + length, message = new $root.openpredict.UserProfileData();
			while (reader.pos < end) {
				let tag = reader.uint32();
				switch (tag >>> 3) {
					case 1: {
						message.v1 = $root.openpredict.UserProfileData.V1.decode(reader, reader.uint32());
						break;
					}
					default:
						reader.skipType(tag & 7);
		...
		UserProfileData.verify = function verify(message) {
			...
			if (message.v1 != null && message.hasOwnProperty("v1")) {
				properties.Contents = 1;
				{
					let error = $root.openpredict.UserProfileData.V1.verify(message.v1);
					if (error)
						return "v1." + error;
				}
			}
		...
		UserProfileData.fromObject = function fromObject(object) {
			if (object instanceof $root.openpredict.UserProfileData)
				return object;
			let message = new $root.openpredict.UserProfileData();
			if (object.v1 != null) {
				if (typeof object.v1 !== "object")
					throw TypeError(".openpredict.UserProfileData.v1: object expected");
				message.v1 = $root.openpredict.UserProfileData.V1.fromObject(object.v1);
			}
			return message;
		};
		...
		UserProfileData.toObject = function toObject(message, options) {
			...
			let object = {};
			if (message.v1 != null && message.hasOwnProperty("v1")) {
				object.v1 = $root.openpredict.UserProfileData.V1.toObject(message.v1, options);
				if (options.oneofs)
					object.Contents = "v1";
			}
			return object;
		...
		UserProfileData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
			...
			return typeUrlPrefix + "/openpredict.UserProfileData";
		};

		UserProfileData.V1 = (function () {
			...
			V1.decode = function decode(reader, length) {
				if (!(reader instanceof $Reader))
					reader = $Reader.create(reader);
				let end = length === undefined ? reader.len : reader.pos + length, message = new $root.openpredict.UserProfileData.V1();
				while (reader.pos < end) {
					let tag = reader.uint32();
					switch (tag >>> 3) {
						case 1: {
			 ...
			 */
			V1.fromObject = function fromObject(object) {
				if (object instanceof $root.openpredict.UserProfileData.V1)
					return object;
				let message = new $root.openpredict.UserProfileData.V1();
				if (object.cid != null)
					if (typeof object.cid === "string")
						$util.base64.decode(object.cid, message.cid = $util.newBuffer($util.base64.length(object.cid)), 0);
					else if (object.cid.length >= 0)
			...
			V1.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
				...
				return typeUrlPrefix + "/openpredict.UserProfileData.V1";
			};
